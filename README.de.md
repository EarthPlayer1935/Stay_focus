...
Eine Chrome-Erweiterung, die jeder Webseite ein Fokus-Spotlight hinzufügt — damit du dich besser auf das Lesen konzentrieren kannst.
...
- 💾 **Gespeicherte Einstellungen** — bleibt auch nach Browser-Neustarts erhalten
- ⚡ **Live-Updates** — Änderungen werden sofort übernommen, ohne die Seite neu laden zu müssen

## Verwendung

1. Installiere die Erweiterung in Chrome (`chrome://extensions/` → Entpackte Erweiterung laden)
...
Weitere Informationen findest du in der [LICENSE](./LICENSE)-Datei oder unter [creativecommons.org/licenses/by-nc-sa/4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/).
