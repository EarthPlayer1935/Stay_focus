...
Une extension Chrome qui ajoute un projecteur de mise au point sur n'importe quelle page web — vous aidant à vous concentrer sur votre lecture.
...
- ↕️ **Réglages Personnalisables** — taille, opacité, couleur et rayon des coins réglables
- 💾 **Persistence des Paramètres** — vos préférences sont conservées après le redémarrage du navigateur
...
Consultez le fichier [LICENSE](./LICENSE) pour plus de détails, ou visitez [creativecommons.org/licenses/by-nc-sa/4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/).
